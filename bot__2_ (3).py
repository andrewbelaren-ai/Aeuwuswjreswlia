...
def init_db():
    ...
    # Атака / Защита (если колонки только что созданы)
    atk_def = {
        'rifle':       (1,  1), 'machinegun':  (3,  2), 'mortar':      (6,  3),
        'apc':         (12, 20),'tank':        (50, 40),'artillery':   (35, 10),
        'aa_gun':      (10, 50),'mlrs':        (70, 20),'missile':     (150,10),
        'plane':       (80, 30),'bomber':      (90, 20),'helicopter':  (50, 30),
        'bomb':        (5,  0), 'corvette':    (40, 30),'ship':        (100,80),
        'submarine':   (90, 60),'cruiser':     (200,160),'carrier':    (300,400),
        'nuclear_sub': (800,500),
    }
    for name, (atk, dfn) in atk_def.items():
        c.execute("UPDATE military_types SET attack_value=?,defense_value=? WHERE name=?", (atk, dfn, name))
...
# ==============================================================
@bot.message_handler(commands=['helpwar'])
@group_only
def cmd_helpwar(message):
    text = (
        'Боевая система\n\n'
        'Для игроков:\n'
        'Наступление: напиши стрелку и юниты\n'
        'Пример: rifle:300 tank:20 plane:5\n\n'
        '/mystrike - статус твоей заявки\n'
        '/warhistory - история наступлений\n\n'
        'Наземные юниты:\n'
        'rifle, machinegun, mortar, apc, tank,\n'
        'artillery, aa_gun, mlrs, missile\n\n'
        'Воздух:\n'
        'plane, bomber, helicopter\n\n'
        'Флот:\n'
        'corvette, ship, submarine,\n'
...
# Регистрируем боевые хендлеры
_init_combat_tables()
_combat_pending_calcs = {}
