...
ГЕТЬ! 🟨⬛🐍:
(От меня)
Массовый призыв (с дебаффами на мораль)
Сделать чтобы бизнесы реально давали деньги в /cash

Airat:
Демобилизация, возможность нанимать контрактные армии

Barakudak / Elsee Geko:
Кредиты

Фиксани баги, фиксани наступление если нет обороны от страны чтобы войска не убивались об воздух а было 0 потерь, также добавь в подсказки команду чтобы можно было защиту войска выставлять , также кроме юнитов чтобы надо было войска (людей ставить)

Также сделай ± за призыв 10к войск

Увеличь войска странам (initcountry) в двое

Придумай новое оформление боту

И вместо "Aurelia - стратегия..." напиши AURELIA BOT V2

Barakudak / Elsee Geko:
Санкции пусть они будут зависить от уровня экономики , типо чел с уровнем экономики 1 не может нанести серьезный ущерб челу с экономикой уровня 20

А если уровень экономики выше у того кто санкции вводит чем у того на кого накладывают санкции то его экономике плохо

и главное вместо "–" используй "-"
